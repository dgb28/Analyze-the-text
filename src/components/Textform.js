...
export default function TextForm(props){    
    ...
    return(
        ...
        <div className="container my-2">
            ...
            <p>{text.split(/\s+/).filter((element)=>{return element.length!==0}).length} words {text.length} is number of character</p>
            <p>{text.split(/\s+/).filter((element)=>{return element.length!==0}).length*0.008 } miutes it will take to read</p>
            <h1>Preview</h1>
